  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        gradient:
          "bg-gradient-to-r from-[#00d2ff] via-[#2dd4bf] to-[#10b981] text-[#050505] font-semibold shadow-lg shadow-cyan-500/15 hover:shadow-emerald-500/30 hover:from-[#22d3ee] hover:via-[#34d399] hover:to-[#059669] hover:scale-[1.02] active:scale-[0.98]",
        glass:
          "glass text-foreground hover:bg-card/80 shadow-sm",
      },
      size: {
